    ...
    <div className="flex w-full h-full flex-1 text-sm sm:text-lg">
      ...
      <div className="flex flex-col items-center w-full h-full flex-1 m-auto max-w-[680px] gap-10 p-2">
              ...
              return (
                <div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 w-full">
                    {group.data &&
                      group.data.map((skillItem) => {
                        return <Skill item={skillItem} />;
                      })}
                  </div>
                </div>
              );
        ...
        <Section title="Achievements" icon={faTrophy}>
          ...
          exercitationem cupiditate in itaque, at nihil quas earum, repudiandae
          odio sit cumque quo impedit. Consequatur dolores voluptatem autem amet
          repellat nobis.
        </Section>
